...
description: Builds and modifies the Smart Farm React + Redux Toolkit UI layer (web-server/client/). Owns components, RTK Query slices, pages, and dashboard layout. Does not own backend Express server (→ backend-api) or tests (→ qa).
