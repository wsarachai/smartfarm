---
name: backend-api
description: Builds and modifies the Smart Farm Node.js/Express backend API layer (web-server/src/). Use when working on telemetry, device control, camera streaming, settings, irrigation scheduler, or AI insights integration.
---
