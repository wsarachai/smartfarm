...
- **AP-only** mode (no STA uplink), WPA2. `WiFi.softAPConfig()` pins the AP IP to `192.168.1.1/24`; the Arduino-ESP32 core auto-starts a DHCP server that leases `192.168.1.2`+ to clients.
