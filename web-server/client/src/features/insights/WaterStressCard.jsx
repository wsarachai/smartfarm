...
export default function WaterStressCard() {
  ...
  return (
    <WidgetCard>
      <div className="p-6 flex flex-col justify-between h-full min-h-[230px]">
        <div>
        ...
        <Link
          ...
          className="mt-4 inline-flex items-center justify-between gap-2 bg-surface-container-high border border-outline-variant px-3 py-2 hover:bg-surface-container-highest transition-colors active:scale-95"
        >
